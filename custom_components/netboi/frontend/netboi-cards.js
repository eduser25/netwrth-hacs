...
var rt = Xb();
const B = /* @__PURE__ */ Qt(rt), JM = new Intl.NumberFormat("en-US", {
  style: "currency",
  currency: "USD",
...
const KR = 6e4;
function Kb(t, e, n) {
  const [r, u] = rt.useState(null), [l, c] = rt.useState(null), [s, h] = rt.useState(!0), [d, y] = rt.useState(null), [p, g] = rt.useState(0), x = rt.useCallback(() => g((A) => A + 1), []), O = rt.useCallback(() => {
    c(null), u(
  ...
  rt.useEffect(() => {
    let A = !0;
    Promise.all([UR(t, e), HR(t, e, n)]).then(([M, C]) => {
      A && (u(M), c(C.series), h(C.censored), y(null));
    }).catch((M) => {
      A && y((M == null ? void 0 : M.message) ?? String(M));
    });
    const T = setInterval(x, KR);
    return () => {
      A = !1, clearInterval(T);
    };
  }, [t, e, n, p, x]);
  const b = rt.useRef(null);
  return b.current = (r == null ? void 0 : r.entry_id) ?? null, rt.useEffect(() => {
    let A = null, T = !0;
    return t.connection.subscribeEvents((M) => {
      const C = b.current;
      (C == null || M.data.entry_id === C) && x();
    }, kR).then((M) => {
      T ? A = M : M();
    }).catch(() => {
    }), () => {
...
const VR = ({ open: t }) => /* @__PURE__ */ it.jsxs("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2.2", children: [
...
function Vb({
  ...
  const y = r ?? n.default_reveal_ttl_minutes, p = async (x) => {
    const O = await GR(t, e, x, y).catch((S) => ({
      ok: !1,
  ...
  return /* @__PURE__ */ it.jsxs(it.Fragment, { children: [
    /* @__PURE__ */ it.jsx(
      "button",
      {
        ...
        onClick: g,
        children: /* @__PURE__ */ it.jsx(VR, { open: !d.censored })
      }
    ),
...
const ZR = ["cash", "investment", "credit", "loan", "other"];
function QR(t, e) {
...
function WR({
  ...
  const n = lu.find((y) => y.key === (e.view ?? "all")) ?? lu[2], { overview: r, masked: u, error: l, refresh: c } = Kb(t, e.entry, "1m"), s = Fb(r), h = rt.useMemo(() => s.filter(n.pick), [s, n]), d = rt.useMemo(
    () => ZR.map((y) => ({
      kind: y,
  ...
  return /* @__PURE__ */ it.jsxs("div", { className: "card", children: [
    ...
    !l && r && d.length > 0 && /* @__PURE__ */ it.jsx("table", { children: /* @__PURE__ */ it.jsx("tbody", { children: d.map((y) => /* @__PURE__ */ it.jsx(JR, { kind: y.kind, accounts: y.accounts, masked: u }, y.kind)) }) })
  ] });
}
function JR({
  kind: t,
  ...
  return /* @__PURE__ */ it.jsxs(it.Fragment, { children: [
    ...
    e.map((r) => /* @__PURE__ */ it.jsxs("tr", { children: [
      /* @__PURE__ */ it.jsxs("td", { children: [
        /* @__PURE__ */ it.jsx("span", { className: `dot ${FR(r.balance_at) ? "stale" : ""}` }),
        r.nickname || r.name,
      ...
      /* @__PURE__ */ it.jsx("td", { className: "num", children: QR(r, n) })
    ] }, r.id))
  ] });
}
function tj(t) {
...
function e3({
  ...
  const n = lu.find((x) => x.key === (e.view ?? "all")) ?? lu[2], [r, u] = rt.useState(e.range ?? "1m"), { overview: l, series: c, masked: s, error: h, refresh: d } = Kb(t, e.entry, r), y = Fb(l), p = rt.useMemo(() => y.filter(n.pick), [y, n]), g = rt.useMemo(() => {
    if (!c) return null;
...
function $r() {
  if (vO) return Mv;
  vO = 1;
  var t = $l(), e = n3(), n = r3(), r = "[object Null]", u = "[object Undefined]", l = t ? t.toStringTag : void 0;
  function c(s) {
...
function u3() {
  if (OO) return $v;
  OO = 1;
  var t = Qb(), e = i3(), n = ba(), r = aj(), u = /[\\^$.*+?()[\]{}|]/g, l = /^\[object .+?Constructor\]$/, c = Function.prototype, s = Object.prototype, h = c.toString, d = s.hasOwnProperty, y = RegExp(
...
function T3() {
  if (WO) return hp;
  WO = 1;
  var t = w3(), e = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, n = /\\(\\)?/g, r = t(function(u) {
    var l = [];
...
var P3 = D3();
const ti = /* @__PURE__ */ Qt(P3);
var N3 = Qb();
const At = /* @__PURE__ */ Qt(N3);
var R3 = ba();
const Ru = /* @__PURE__ */ Qt(R3);
var _p = { exports: {} }, Ut = {};
/**
 * @license React
...
var cA;
function z3() {
  return cA || (cA = 1, _p.exports = q3()), _p.exports;
}
var $3 = z3(), Op, fA;
function cj() {
  if (fA) return Op;
...
var L3 = B3();
const qu = /* @__PURE__ */ Qt(L3);
var k3 = cj();
const U3 = /* @__PURE__ */ Qt(k3);
var Hn = function(e) {
...
var X3 = ["viewBox", "children"], K3 = [
  ...
  if (!e || typeof e == "function" || typeof e == "boolean")
    return null;
  var r = e;
  if (/* @__PURE__ */ rt.isValidElement(e) && (r = e.props), !Ru(r))
    return null;
  var u = {};
  ...
  return Object.keys(e).forEach(function(l) {
    var c = e[l];
    r0.includes(l) && typeof c == "function" && (u || (u = {}), u[l] = V3(c, n, r));
  }), u;
}, F3 = ["children"], Z3 = ["children"];
function dA(t, e) {
  if (t == null) return {};
  var n = Q3(t, e), r, u;
...
var vA = {
  ...
  return rt.Children.forEach(e, function(r) {
    Mt(r) || ($3.isFragment(r) ? n = n.concat(t(r.props.children)) : n.push(r));
  }), Tp = n, pA = e, n;
};
function Cn(t, e) {
  var n = [], r = [];
...
var yA = function(e) {
...
}, W3 = ["a", "altGlyph", "altGlyphDef", "altGlyphItem", "animate", "animateColor", "animateMotion", "animateTransform", "circle", "clipPath", "color-profile", "cursor", "defs", "desc", "ellipse", "feBlend", "feColormatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDistantLight", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence", "filter", "font", "font-face", "font-face-format", "font-face-name", "font-face-url", "foreignObject", "g", "glyph", "glyphRef", "hkern", "image", "line", "lineGradient", "marker", "mask", "metadata", "missing-glyph", "mpath", "path", "pattern", "polygon", "polyline", "radialGradient", "rect", "script", "set", "stop", "style", "svg", "switch", "symbol", "text", "textPath", "title", "tref", "tspan", "use", "view", "vkern"], J3 = function(e) {
  return e && e.type && ti(e.type) && W3.indexOf(e.type) >= 0;
}, fj = function(e) {
  return e && jg(e) === "object" && "clipDot" in e;
}, tq = function(e, n, r, u) {
  var l, c = (l = wp == null ? void 0 : wp[u]) !== null && l !== void 0 ? l : [];
  return n.startsWith("data-") || !At(e) && (u && c.includes(n) || K3.includes(n)) || r && r0.includes(n);
}, Et = function(e, n, r) {
  if (!e || typeof e == "function" || typeof e == "boolean")
    return null;
  var u = e;
  if (/* @__PURE__ */ rt.isValidElement(e) && (u = e.props), !Ru(u))
    return null;
  var l = {};
  return Object.keys(u).forEach(function(c) {
    var s;
    tq((s = u) === null || s === void 0 ? void 0 : s[c], c, n, r) && (l[c] = u[c]);
  }), l;
}, Cg = function t(e, n) {
  if (e === n)
    return !0;
  ...
  if (Mt(e) && Mt(n))
    return !0;
  if (!Mt(e) && !Mt(n)) {
    var r = e.props || {}, u = r.children, l = dA(r, F3), c = n.props || {}, s = c.children, h = dA(c, Z3);
...
}, rq = ["children", "width", "height", "viewBox", "className", "style", "title", "desc"];
function Dg() {
...
function Pg(t) {
  var e = t.children, n = t.width, r = t.height, u = t.viewBox, l = t.className, c = t.style, s = t.title, h = t.desc, d = aq(t, rq), y = u || {
    width: n,
    height: r,
    x: 0,
    y: 0
...
var Jt = /* @__PURE__ */ B.forwardRef(function(t, e) {
  var n = t.children, r = t.className, u = oq(t, uq), l = qt("recharts-layer", r);
...
function pq() {
  if (TA) return Rp;
  TA = 1;
  var t = vq(), e = t("toUpperCase");
  return Rp = e, Rp;
}
var yq = pq();
const Ds = /* @__PURE__ */ Qt(yq);
function Wt(t) {
  return function() {
    return t;
  };
}
const hj = Math.cos, jf = Math.sin, In = Math.sqrt, Cf = Math.PI, Ps = 2 * Cf, Rg = Math.PI, qg = 2 * Rg, Ia = 1e-6, mq = qg - Ia;
function dj(t) {
  this._ += t[0];
...
class bq {
  constructor(e) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = e == null ? dj : gq(e);
  }
  moveTo(e, n) {
  ...
  arc(e, n, r, u, l, c) {
    ...
    this._x1 === null ? this._append`M${d},${y}` : (Math.abs(this._x1 - d) > Ia || Math.abs(this._y1 - y) > Ia) && this._append`L${d},${y}`, r && (g < 0 && (g = g % qg + qg), g > mq ? this._append`A${r},${r},0,1,${p},${e - s},${n - h}A${r},${r},0,1,${p},${this._x1 = d},${this._y1 = y}` : g > Ia && this._append`A${r},${r},0,${+(g >= Rg)},${p},${this._x1 = e + r * Math.cos(l)},${this._y1 = n + r * Math.sin(l)}`);
  }
  rect(e, n, r, u) {
...
}, bj = In(1 / 3), Oq = bj * 2, Aq = {
  draw(t, e) {
    const n = In(e / Oq), r = n * bj;
...
}, Tq = 0.8908130915292852, xj = jf(Cf / 10) / jf(7 * Cf / 10), Eq = jf(Ps / 10) * xj, Mq = -hj(Ps / 10) * xj, jq = {
  draw(t, e) {
    const n = In(e * Tq), r = Eq * n, u = Mq * n;
...
}, wn = -0.5, Tn = In(3) / 2, zg = 1 / In(12), Dq = (zg / 2 + 1) * 3, Pq = {
  draw(t, e) {
    const n = In(e / Dq), r = n / 2, u = n * zg, l = r, c = n * zg + n, s = -l, h = c;
...
function Xq() {
  var t = Wt([]), e = $g, n = cu, r = Gq;
  function u(l) {
    var c = Array.from(t.apply(this, arguments), Yq), s, h = c.length, d = -1, y;
    for (const p of l)
      for (s = 0, ++d; s < h; ++s)
...
var Mj = {
  ...
  var n = e.type, r = n === void 0 ? "circle" : n, u = e.size, l = u === void 0 ? 64 : u, c = e.sizeType, s = c === void 0 ? "area" : c, h = tz(e, Zq), d = PA(PA({}, h), {}, {
    type: r,
    size: l,
    sizeType: s
  }), y = function() {
    var b = rz(r), A = Nq().type(b).size(az(l, s, r));
    return A();
...
function cz(t, e, n) {
  return e && lz(t.prototype, e), Object.defineProperty(t, "prototype", { writable: !1 }), t;
}
function fz(t, e, n) {
  return e = Rf(e), sz(t, jj() ? Reflect.construct(e, n || [], Rf(t).constructor) : e.apply(t, n));
}
function sz(t, e) {
...
var En = 32, c0 = /* @__PURE__ */ (function(t) {
  function e() {
    return oz(this, e), fz(this, e, arguments);
  }
  return dz(e, t), cz(e, [{
    key: "renderIcon",
    value: (
...
function Dj() {
  if (LA) return Hp;
  LA = 1;
  var t = Ms(), e = pz(), n = yz(), r = mz(), u = gz(), l = bz();
  function c(s) {
...
function Az() {
  if (FA) return Wp;
  FA = 1;
  var t = $l(), e = _z(), n = Wb(), r = qj(), u = Oz(), l = f0(), c = 1, s = 2, h = "[object Boolean]", d = "[object Date]", y = "[object Error]", p = "[object Map]", g = "[object Number]", x = "[object RegExp]", O = "[object Set]", S = "[object String]", b = "[object Symbol]", A = "[object ArrayBuffer]", T = "[object DataView]", M = t ? t.prototype : void 0, C = M ? M.valueOf : void 0;
...
function Mz() {
  if (tw) return ry;
  tw = 1;
  var t = Tz(), e = Ez(), n = Object.prototype, r = n.propertyIsEnumerable, u = Object.getOwnPropertySymbols, l = u ? function(c) {
...
function s0() {
  if (rw) return uy;
  rw = 1;
  var t = Cz(), e = Br(), n = Object.prototype, r = n.hasOwnProperty, u = n.propertyIsEnumerable, l = t(/* @__PURE__ */ (function() {
    return arguments;
  })()) ? t : function(c) {
...
function $j() {
  return iw || (iw = 1, (function(t, e) {
    var n = rr(), r = Dz(), u = e && !e.nodeType && e, l = u && !0 && t && !t.nodeType && t, c = l && l.exports === u, s = c ? n.Buffer : void 0, h = s ? s.isBuffer : void 0, d = h || r;
    t.exports = d;
...
function Lj() {
  if (sw) return hy;
  sw = 1;
  var t = Pz(), e = Bj(), n = Nz(), r = n && n.isTypedArray, u = r ? e(r) : t;
  return hy = u, hy;
}
var dy, hw;
function Rz() {
  if (hw) return dy;
  hw = 1;
  var t = jz(), e = s0(), n = Je(), r = $j(), u = h0(), l = Lj(), c = Object.prototype, s = c.hasOwnProperty;
  function h(d, y) {
...
function $z() {
  if (yw) return my;
  yw = 1;
  var t = qz(), e = zz(), n = Object.prototype, r = n.hasOwnProperty;
  function u(l) {
    if (!t(l))
      return e(l);
    var c = [];
...
function Lz() {
  if (xw) return Sy;
  xw = 1;
  var t = Bz(), e = 1, n = Object.prototype, r = n.hasOwnProperty;
...
function Iz() {
  if (ww) return Ty;
  ww = 1;
  var t = kz(), e = Jb(), n = Uz(), r = Uj(), u = Hz(), l = $r(), c = aj(), s = "[object Map]", h = "[object Object]", d = "[object Promise]", y = "[object Set]", p = "[object WeakMap]", g = "[object DataView]", x = c(t), O = c(e), S = c(n), b = c(r), A = c(u), T = l;
...
function Gz() {
  if (Tw) return Ey;
  Tw = 1;
  var t = Dj(), e = qj(), n = Az(), r = Lz(), u = Iz(), l = Je(), c = $j(), s = Lj(), h = 1, d = "[object Arguments]", y = "[object Array]", p = "[object Object]", g = Object.prototype, x = g.hasOwnProperty;
...
function Qz() {
  if (zw) return $y;
  zw = 1;
  var t = v0(), e = lj(), n = Zz(), r = Zb(), u = Hj(), l = Ij(), c = Cs(), s = 1, h = 2;
  function d(y, p) {
...
function o$() {
  if (Fw) return Zy;
  Fw = 1;
  var t = Uj(), e = u$(), n = f0(), r = 1 / 0, u = t && 1 / n(new t([, -0]))[1] == r ? function(l) {
    return new t(l);
  } : e;
  return Zy = u, Zy;
}
...
function l$() {
  if (Zw) return Qy;
  Zw = 1;
  var t = Pj(), e = a$(), n = i$(), r = Rj(), u = o$(), l = f0(), c = 200;
  function s(h, d, y) {
...
function v$(t, e, n) {
  return e = qf(e), p$(t, Xj() ? Reflect.construct(e, n || [], qf(t).constructor) : e.apply(t, n));
}
function p$(t, e) {
...
var eT = 1, au = /* @__PURE__ */ (function(t) {
  function e() {
    ...
    for (var r = arguments.length, u = new Array(r), l = 0; l < r; l++)
      u[l] = arguments[l];
    return n = v$(this, e, [].concat(u)), zs(n, "lastBoundingBox", {
      width: -1,
      height: -1
    }), n;
  }
...
function C$() {
  if (dT) return fm;
  dT = 1;
  var t = e0(), e = n0(), n = xa(), r = Zj(), u = E$(), l = Bj(), c = j$(), s = $u(), h = Je();
  function d(y, p, g) {
...
function R$() {
  if (gT) return pm;
  gT = 1;
  var t = N$(), e = Qj(), n = $u(), r = e ? function(u, l) {
    return e(u, "toString", {
      configurable: !0,
      enumerable: !1,
      value: t(l),
...
function B$() {
  if (OT) return xm;
  OT = 1;
  var t = Vj(), e = C$(), n = $$(), r = $s(), u = n(function(l, c) {
    if (l == null)
      return [];
    var s = c.length;
...
function Y$(t, e, n) {
  return e = X$(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function X$(t) {
  var e = K$(t, "string");
    ...
    if (y && y.length) {
      var $ = {
        ...
        var N = Sm({
          ...
          paddingBottom: 4,
          color: Z.color || "#000"
        }, s), I = Z.formatter || p || V$, W = Z.value, ut = Z.name, lt = W, P = ut;
        if (I && lt != null && P != null) {
          var U = I(W, ut, Z, V, y);
          if (Array.isArray(U)) {
            var et = k$(U, 2);
...
function sf(t, e, n) {
  return e = Z$(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function Z$(t) {
  var e = Q$(t, "string");
...
var $o = "recharts-tooltip-wrapper", W$ = {
  visibility: "hidden"
};
function J$(t) {
...
function aB(t, e, n) {
  return e && rB(t.prototype, e), Object.defineProperty(t, "prototype", { writable: !1 }), t;
}
function iB(t, e, n) {
  return e = zf(e), uB(t, Wj() ? Reflect.construct(e, n || [], zf(t).constructor) : e.apply(t, n));
}
function uB(t, e) {
...
var jT = 1, fB = /* @__PURE__ */ (function(t) {
  function e() {
    var n;
    nB(this, e);
    for (var r = arguments.length, u = new Array(r), l = 0; l < r; l++)
      u[l] = arguments[l];
    return n = iB(this, e, [].concat(u)), Gg(n, "state", {
      dismissed: !1,
  ...
  return lB(e, t), aB(e, [{
    ...
    key: "render",
    value: function() {
      var r = this, u = this.props, l = u.active, c = u.allowEscapeViewBox, s = u.animationDuration, h = u.animationEasing, d = u.children, y = u.coordinate, p = u.hasPayload, g = u.isAnimationActive, x = u.offset, O = u.position, S = u.reverseDirection, b = u.useTranslate3d, A = u.viewBox, T = u.wrapperStyle, M = eB({
...
function pB(t, e, n) {
  return e = $f(e), yB(t, tC() ? Reflect.construct(e, n || [], $f(t).constructor) : e.apply(t, n));
}
function yB(t, e) {
...
function SB(t, e) {
  return /* @__PURE__ */ B.isValidElement(t) ? /* @__PURE__ */ B.cloneElement(t, e) : typeof t == "function" ? /* @__PURE__ */ B.createElement(t, e) : /* @__PURE__ */ B.createElement(F$, e);
}
var dn = /* @__PURE__ */ (function(t) {
  function e() {
    return hB(this, e), pB(this, e, arguments);
  }
  return gB(e, t), vB(e, [{
    key: "render",
    value: function() {
      ...
      var E = w.length > 0;
      return /* @__PURE__ */ B.createElement(fB, {
        allowEscapeViewBox: c,
        animationDuration: s,
        animationEasing: h,
        isAnimationActive: g,
...
function nC() {
  if (qT) return wm;
  qT = 1;
  var t = AB(), e = ba(), n = Nu(), r = NaN, u = /^[-+]0x[0-9a-f]+$/i, l = /^0b[01]+$/i, c = /^0o[0-7]+$/i, s = parseInt;
  function h(d) {
    if (typeof d == "number")
      return d;
    if (n(d))
...
function wB() {
  if (zT) return Tm;
  zT = 1;
  var t = ba(), e = _B(), n = nC(), r = "Expected a function", u = Math.max, l = Math.min;
  function c(s, h, d) {
...
function TB() {
  if ($T) return Em;
  $T = 1;
  var t = wB(), e = ba(), n = "Expected a function";
  function r(u, l, c) {
    var s = !0, h = !0;
...
function MB(t, e, n) {
  return e = jB(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function jB(t) {
  var e = CB(t, "string");
...
var df = /* @__PURE__ */ rt.forwardRef(function(t, e) {
  var n = t.aspect, r = t.initialDimension, u = r === void 0 ? {
    width: -1,
    height: -1
  } : r, l = t.width, c = l === void 0 ? "100%" : l, s = t.height, h = s === void 0 ? "100%" : s, d = t.minWidth, y = d === void 0 ? 0 : d, p = t.minHeight, g = t.maxHeight, x = t.children, O = t.debounce, S = O === void 0 ? 0 : O, b = t.id, A = t.className, T = t.onResize, M = t.style, C = M === void 0 ? {} : M, w = rt.useRef(null), E = rt.useRef();
  E.current = T, rt.useImperativeHandle(e, function() {
  ...
  }), R = DB(D, 2), z = R[0], F = R[1], k = rt.useCallback(function(K, Z) {
    F(function(V) {
...
function zB(t, e, n) {
  return e = $B(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function $B(t) {
  var e = BB(t, "string");
...
var Qo = function(e) {
  ...
  try {
    ...
    return Zi.widthCache[u] = h, ++Zi.cacheCount > LB && (Zi.cacheCount = 0, Zi.widthCache = {}), h;
  } catch {
    return {
      width: 0,
      height: 0
...
function IT(t, e) {
  for (var n = 0; n < e.length; n++) {
    var r = e[n];
    r.enumerable = r.enumerable || !1, r.configurable = !0, "value" in r && (r.writable = !0), Object.defineProperty(t, FB(r.key), r);
  }
}
function VB(t, e, n) {
...
var GT = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, YT = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/, QB = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/, WB = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/, aC = {
  cm: 96 / 2.54,
  mm: 96 / 25.4,
  pt: 96 / 72,
  pc: 96 / 6,
  ...
  Q: 96 / (2.54 * 40),
  px: 1
}, JB = Object.keys(aC), tu = "NaN";
function t8(t, e) {
  return t * aC[e];
}
var vf = /* @__PURE__ */ (function() {
  function t(e, n) {
    KB(this, t), this.num = e, this.unit = n, this.num = e, this.unit = n, Number.isNaN(e) && (this.unit = ""), n !== "" && !QB.test(n) && (this.num = NaN, this.unit = ""), JB.includes(n) && (this.num = t8(e, n), this.unit = "px");
  }
  return VB(t, [{
    key: "add",
    value: function(n) {
    ...
    key: "parse",
    value: function(n) {
      var r, u = (r = WB.exec(n)) !== null && r !== void 0 ? r : [], l = Bf(u, 3), c = l[1], s = l[2];
...
function Mm(t) {
  var e = r8(t.slice(5, -1));
  return e === tu ? "" : e;
}
var a8 = ["x", "y", "lineHeight", "capHeight", "scaleToFit", "textAnchor", "verticalAnchor", "fill"], i8 = ["dx", "dy", "angle", "className", "breakAll"];
function Kg() {
...
var uC = /[ \f\n\r\t\v\u2028\u2029]+/, oC = function(e) {
  ...
  var n = e.x, r = n === void 0 ? 0 : n, u = e.y, l = u === void 0 ? 0 : u, c = e.lineHeight, s = c === void 0 ? "1em" : c, h = e.capHeight, d = h === void 0 ? "0.71em" : h, y = e.scaleToFit, p = y === void 0 ? !1 : y, g = e.textAnchor, x = g === void 0 ? "start" : g, O = e.verticalAnchor, S = O === void 0 ? "end" : O, b = e.fill, A = b === void 0 ? QT : b, T = KT(e, a8), M = rt.useMemo(function() {
    return h8({
      breakAll: T.breakAll,
      children: T.children,
      maxLines: T.maxLines,
  ...
  }, [T.breakAll, T.children, T.maxLines, p, T.style, T.width]), C = T.dx, w = T.dy, E = T.angle, D = T.className, R = T.breakAll, z = KT(T, i8);
  if (!_e(r) || !_e(l))
    return null;
...
function b0(t) {
  let e, n, r;
  t.length !== 2 ? (e = ga, n = (s, h) => ga(t(s), h), r = (s, h) => t(s) - h) : (e = t === ga || t === d8 ? t : v8, n = t, r = t);
...
class WT extends Map {
  ...
  set(e, n) {
    return super.set(m8(this, e), n);
  }
  delete(e) {
    return super.delete(g8(this, e));
  }
}
...
function g8({ _intern: t, _key: e }, n) {
  const r = e(n);
...
const S8 = Math.sqrt(50), _8 = Math.sqrt(10), O8 = Math.sqrt(2);
function kf(t, e, n) {
  const r = (e - t) / Math.max(0, n), u = Math.floor(Math.log10(r)), l = r / Math.pow(10, u), c = l >= S8 ? 10 : l >= _8 ? 5 : l >= O8 ? 2 : 1;
  let s, h, d;
...
function A8(t, e, n) {
  if (t = Float64Array.from(p8(t)), !(!(r = t.length) || isNaN(e = +e))) {
...
var fl = 0.7, Uf = 1 / fl, iu = "\\s*([+-]?\\d+)\\s*", sl = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", Wn = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", E8 = /^#([0-9a-f]{3,8})$/, M8 = new RegExp(`^rgb\\(${iu},${iu},${iu}\\)$`), j8 = new RegExp(`^rgb\\(${Wn},${Wn},${Wn}\\)$`), C8 = new RegExp(`^rgba\\(${iu},${iu},${iu},${sl}\\)$`), D8 = new RegExp(`^rgba\\(${Wn},${Wn},${Wn},${sl}\\)$`), P8 = new RegExp(`^hsl\\(${sl},${Wn},${Wn}\\)$`), N8 = new RegExp(`^hsla\\(${sl},${Wn},${Wn},${sl}\\)$`), nE = {
  aliceblue: 15792383,
...
function hl(t) {
  var e, n;
  return t = (t + "").trim().toLowerCase(), (e = E8.exec(t)) ? (n = e[1].length, e = parseInt(e[1], 16), n === 6 ? iE(e) : n === 3 ? new We(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, (e & 15) << 4 | e & 15, 1) : n === 8 ? pf(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (e & 255) / 255) : n === 4 ? pf(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | e & 240, ((e & 15) << 4 | e & 15) / 255) : null) : (e = M8.exec(t)) ? new We(e[1], e[2], e[3], 1) : (e = j8.exec(t)) ? new We(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, 1) : (e = C8.exec(t)) ? pf(e[1], e[2], e[3], e[4]) : (e = D8.exec(t)) ? pf(e[1] * 255 / 100, e[2] * 255 / 100, e[3] * 255 / 100, e[4]) : (e = P8.exec(t)) ? lE(e[1], e[2] / 100, e[3] / 100, 1) : (e = N8.exec(t)) ? lE(e[1], e[2] / 100, e[3] / 100, e[4]) : nE.hasOwnProperty(t) ? iE(nE[t]) : t === "transparent" ? new We(NaN, NaN, NaN, 0) : null;
}
function iE(t) {
...
function Wg(t, e, n, r) {
  return arguments.length === 1 ? z8(t) : new We(t, e, n, r ?? 1);
}
function We(t, e, n, r) {
...
function U8(t) {
  return (t = +t) == 1 ? vC : function(e, n) {
    return n - e ? k8(e, n, t) : _0(isNaN(e) ? n : e);
  };
}
function vC(t, e) {
  var n = e - t;
  return n ? L8(t, n) : _0(isNaN(t) ? e : t);
}
...
function F8(t, e) {
  ...
  return n < e.length && (l = e.slice(n), s[c] ? s[c] += l : s[++c] = l), s.length < 2 ? h[0] ? V8(h[0].x) : K8(e) : (e = h.length, function(d) {
...
function Bu(t, e) {
  var n = typeof e, r;
  return e == null || n === "boolean" ? _0(e) : (n === "number" ? If : n === "string" ? (r = hl(e)) ? (e = r, fE) : F8 : e instanceof hl ? fE : e instanceof Date ? Y8 : I8(e) ? H8 : Array.isArray(e) ? G8 : typeof e.valueOf != "function" && typeof e.toString != "function" || isNaN(e) ? X8 : If)(t, e);
}
function O0(t, e) {
  return t = +t, e = +e, function(n) {
...
function Bs() {
  ...
  function y() {
    ...
    return c !== Ie && (c = W8(t[0], t[g - 1])), s = g > 2 ? t4 : J8, h = d = null, p;
  }
  function p(g) {
...
var a4 = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function dl(t) {
  if (!(e = a4.exec(t))) throw new Error("invalid format: " + t);
  var e;
  return new w0({
    fill: e[1],
    align: e[2],
...
function o4(t) {
  var e = t.grouping === void 0 || t.thousands === void 0 ? vE : n4(pE.call(t.grouping, Number), t.thousands + ""), n = t.currency === void 0 ? "" : t.currency[0] + "", r = t.currency === void 0 ? "" : t.currency[1] + "", u = t.decimal === void 0 ? "." : t.decimal + "", l = t.numerals === void 0 ? vE : r4(pE.call(t.numerals, String)), c = t.percent === void 0 ? "%" : t.percent + "", s = t.minus === void 0 ? "−" : t.minus + "", h = t.nan === void 0 ? "NaN" : t.nan + "";
  function d(p, g) {
    p = dl(p);
    ...
    function k($) {
      ...
      if (E === "c")
        ...
        $ = +$;
        var W = $ < 0 || 1 / $ < 0;
        if ($ = isNaN($) ? h : z(Math.abs($), C), w && ($ = i4($)), W && +$ == 0 && S !== "+" && (W = !1), K = (W ? S === "(" ? S : s : S === "-" || S === "(" ? "" : S) + K, Z = (E === "s" && !isNaN($) && Xf !== void 0 ? yE[8 + Xf / 3] : "") + Z + (W && S === "(" ? ")" : ""), F) {
...
function l4(t) {
  return mf = o4(t), T0 = mf.format, pC = mf.formatPrefix, mf;
}
function c4(t) {
...
function yC(t, e, n, r) {
  ...
  switch (r = dl(r ?? ",f"), r.type) {
    case "s": {
      ...
      return r.precision == null && !isNaN(l = f4(u, c)) && (r.precision = l), pC(r, c);
    }
    case "":
    case "e":
    case "g":
    case "p":
    case "r": {
      r.precision == null && !isNaN(l = s4(u, Math.max(Math.abs(t), Math.abs(e)))) && (r.precision = l - (r.type === "e"));
      break;
    }
    case "f":
    case "%": {
      r.precision == null && !isNaN(l = c4(u)) && (r.precision = l - (r.type === "%") * 2);
      break;
    }
  }
  return T0(r);
...
function p4(t) {
  return t === 10 ? v4 : t === Math.E ? Math.exp : (e) => Math.pow(t, e);
}
function y4(t) {
...
function E0(t) {
  ...
  let r = 10, u, l;
  function c() {
    return u = y4(r), l = p4(r), n()[0] < 0 ? (u = bE(u), l = bE(l), t(h4, d4)) : t(mE, gE), e;
  }
...
function j0(t) {
  var e = t(Ie, Ie), n = 1;
  function r() {
    return n === 1 ? t(Ie, Ie) : n === 0.5 ? t(m4, g4) : t(_E(n), _E(1 / n));
  }
...
function _C() {
  ...
  function u() {
    ...
    for (n = new Array(s - 1); ++c < s; ) n[c - 1] = w8(t, c / s);
    return l;
  }
  function l(c) {
...
const ks = oi(0), Ff = oi(1), S4 = oi(2), _4 = oi(3), pu = oi(4), O4 = oi(5), A4 = oi(6);
ks.range;
Ff.range;
S4.range;
_4.range;
...
const Us = li(0), Zf = li(1), w4 = li(2), T4 = li(3), yu = li(4), E4 = li(5), M4 = li(6);
Us.range;
Zf.range;
w4.range;
T4.range;
...
const [j4, C4] = TC(zr, $0, Us, wC, q0, N0), [D4, P4] = TC(qr, z0, ks, Hl, R0, P0);
function Rm(t) {
  if (0 <= t.y && t.y < 100) {
...
function ko(t) {
  return new RegExp("^(?:" + t.map(z4).join("|") + ")", "i");
}
function Uo(t) {
...
function N6(t) {
  return Qi = N4(t), DC = Qi.format, Qi.parse, PC = Qi.utcFormat, Qi.utcParse, Qi;
}
function R6(t) {
  return new Date(t);
}
...
function B0(t, e, n, r, u, l, c, s, h, d) {
  ...
  return y.invert = function(E) {
    ...
    return arguments.length ? g(Array.from(E, q6)) : g().map(R6);
  }, y.ticks = function(E) {
    var D = g();
...
function z6() {
  return Pn.apply(B0(D4, P4, qr, z0, ks, Hl, R0, P0, Va, DC).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
function $6() {
  return Pn.apply(B0(j4, C4, zr, $0, Us, Ls, q0, N0, Va, PC).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
function Hs() {
...
function zC() {
  ...
  return n.domain = function(r) {
    ...
    return Array.from({ length: r + 1 }, (u, l) => A8(t, l / r));
  }, n.copy = function() {
...
function Is() {
  ...
  function O(S) {
    return function(b) {
      var A, T, M;
      return arguments.length ? ([A, T, M] = b, d = Z8(S, [A, T, M]), x) : [d(0), d(0.5), d(1)];
    };
  }
...
}, H0, ie = !0, Dn = "[DecimalError] ", Wa = Dn + "Invalid argument: ", U0 = Dn + "Exponent out of range: ", ku = Math.floor, Ga = Math.pow, J6 = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, vn, Te = 1e7, re = 7, UC = 9007199254740991, Qf = ku(UC / re), ht = {};
...
function YC(t) {
  ...
  function u(l) {
    ...
    if (typeof l == "number") {
      ...
      throw Error(Wa + l);
    if (l.charCodeAt(0) === 45 ? (l = l.slice(1), c.s = -1) : c.s = 1, J6.test(l)) GE(c, l);
    else throw Error(Wa + l);
  }
  if (u.prototype = ht, u.ROUND_UP = 0, u.ROUND_DOWN = 1, u.ROUND_CEIL = 2, u.ROUND_FLOOR = 3, u.ROUND_HALF_UP = 4, u.ROUND_HALF_DOWN = 5, u.ROUND_HALF_EVEN = 6, u.ROUND_HALF_CEIL = 7, u.ROUND_HALF_FLOOR = 8, u.clone = YC, u.config = u.set = tL, t === void 0 && (t = {}), t)
...
var uL = function(e) {
  ...
  return e === 1 ? n : XE(function() {
    ...
    return c >= e ? n.apply(void 0, u) : t(e - c, XE(function() {
      ...
      return n.apply(void 0, eL(y).concat(h));
    }));
  });
}, Ys = function(e) {
  return oL(e.length, e);
}, nb = function(e, n) {
  for (var r = [], u = e; u < n; ++u)
    r[u - e] = u;
  return r;
...
var hL = Ys(function(t, e, n) {
  var r = +t, u = +e;
  return r + n * (u - r);
}), dL = Ys(function(t, e, n) {
  var r = e - +t;
  return r = r || 1 / 0, (n - t) / r;
}), vL = Ys(function(t, e, n) {
  var r = e - +t;
...
const Xs = {
  ...
  uninterpolateNumber: dL,
  uninterpolateTruncation: vL
};
function ab(t) {
  return mL(t) || yL(t) || FC(t) || pL();
}
function pL() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function SL(t, e, n) {
  ...
  var c = Math.floor((e - 1) / 2), s = cL(lL(function(h) {
...
var AL = VC(_L), wL = VC(OL), TL = "Invariant failed";
function ri(t, e) {
  throw new Error(TL);
}
var EL = ["offset", "layout", "width", "dataKey", "data", "dataPointFormatter", "xAxis", "yAxis"];
function gu(t) {
  "@babel/helpers - typeof";
...
function $L(t, e, n) {
  return e && zL(t.prototype, e), Object.defineProperty(t, "prototype", { writable: !1 }), t;
}
function BL(t, e, n) {
  return e = Jf(e), LL(t, JC() ? Reflect.construct(e, n || [], Jf(t).constructor) : e.apply(t, n));
}
function LL(t, e) {
...
var Il = /* @__PURE__ */ (function(t) {
  function e() {
    return qL(this, e), BL(this, e, arguments);
  }
  return UL(e, t), $L(e, [{
    key: "render",
    value: function() {
      var r = this.props, u = r.offset, l = r.layout, c = r.width, s = r.dataKey, h = r.data, d = r.dataPointFormatter, y = r.xAxis, p = r.yAxis, g = NL(r, EL), x = Et(g, !1);
...
function IL(t, e, n) {
  return e = GL(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function GL(t) {
  var e = YL(t, "string");
...
var WL = function(e) {
  ...
  var c = n.props.children, s = Cn(c, Il).filter(function(d) {
    return n5(u, l, d.props.direction);
  });
  if (s && s.length) {
  ...
  }), l = f5[r], c = Xq().keys(u).value(function(s, h) {
    return +Ge(s, h, 0);
  }).order($g).offset(l);
  return c(e);
}, h5 = function(e, n, r, u, l, c) {
  if (!e)
    return null;
...
function m5(t, e, n) {
  return e = g5(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function g5(t) {
  var e = b5(t, "string");
...
var ns = Math.PI / 180, x5 = function(e) {
  ...
  var r = e.x, u = e.y, l = n.cx, c = n.cy, s = S5({
    x: r,
    y: u
  }, {
    x: l,
  ...
  if (c === 0)
    return !0;
  var y = O5(n), p = y.startAngle, g = y.endAngle, x = s, O;
  if (p <= g) {
    for (; x > g; )
      x -= 360;
    for (; x < p; )
...
function N5(t, e, n) {
  return e = R5(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function R5(t) {
  var e = q5(t, "string");
...
var z5 = function(e) {
  ...
  var u = e.position, l = e.viewBox, c = e.offset, s = e.className, h = l, d = h.cx, y = h.cy, p = h.innerRadius, g = h.outerRadius, x = h.startAngle, O = h.endAngle, S = h.clockWise, b = (p + g) / 2, A = $5(x, O), T = A >= 0 ? 1 : -1, M, C;
...
function ke(t) {
  var e = t.offset, n = e === void 0 ? 5 : e, r = D5(t, w5), u = Se({
    offset: n
  ...
  var x;
  if (At(d)) {
    if (x = /* @__PURE__ */ rt.createElement(d, u), /* @__PURE__ */ rt.isValidElement(x))
      return x;
  } else
    x = z5(u);
  var O = U5(l), S = Et(u, !0);
...
var cD = function(e) {
  ...
  if (!r)
    return c;
  var s = H5(e.label, n || l);
  return [s].concat(T5(c));
};
ke.parseViewBox = cD;
ke.renderCallByParent = I5;
var Xm, u2;
function G5() {
  if (u2) return Xm;
  u2 = 1;
...
var K5 = ["valueAccessor"], V5 = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
function F5(t) {
  return J5(t) || W5(t) || Q5(t) || Z5();
}
function Z5() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var ak = function(e) {
  return Array.isArray(e.value) ? X5(e.value) : e.value;
};
function Nr(t) {
  var e = t.valueAccessor, n = e === void 0 ? ak : e, r = c2(t, K5), u = r.data, l = r.dataKey, c = r.clockWise, s = r.id, h = r.textBreakAll, d = c2(r, V5);
...
function uk(t, e) {
  ...
  if (!n)
    return u;
  var l = ik(t.label, e);
  return [l].concat(F5(u));
}
Nr.renderCallByParent = uk;
function _l(t) {
  "@babel/helpers - typeof";
...
function ok(t, e, n) {
  return e = lk(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function lk(t) {
  var e = ck(t, "string");
...
var fk = function(e, n) {
  ...
  var n = e.cx, r = e.cy, u = e.innerRadius, l = e.outerRadius, c = e.startAngle, s = e.endAngle, h = fk(c, s), d = c + h, y = qe(n, r, l, c), p = qe(n, r, l, d), g = "M ".concat(y.x, ",").concat(y.y, `
  ...
  var n = s2(s2({}, hk), e), r = n.cx, u = n.cy, l = n.innerRadius, c = n.outerRadius, s = n.cornerRadius, h = n.forceCornerRadius, d = n.cornerIsExternal, y = n.startAngle, p = n.endAngle, g = n.className;
  if (c < l || y === p)
    return null;
  var x = qt("recharts-sector", g), O = c - l, S = ei(s, O, 0, !0), b;
  return S > 0 && Math.abs(y - p) < 360 ? b = sk({
    cx: r,
    cy: u,
    innerRadius: l,
    outerRadius: c,
...
var v2 = {
  ...
  var n = e.type, r = n === void 0 ? "linear" : n, u = e.points, l = u === void 0 ? [] : u, c = e.baseLine, s = e.layout, h = e.connectNulls, d = h === void 0 ? !1 : h, y = yk(r, s), p = d ? l.filter(function(S) {
    return xf(S);
  }) : l, g;
  if (Array.isArray(c)) {
  ...
  if ((!r || !r.length) && !u)
    return null;
  var c = r && r.length ? mk(e) : u;
  return /* @__PURE__ */ rt.createElement("path", hb({}, Et(e, !1), Ef(e), {
...
var m2;
function xk() {
  return m2 || (m2 = 1, Km.exports = /* @__PURE__ */ bk()()), Km.exports;
}
var Sk = /* @__PURE__ */ xk();
const Ht = /* @__PURE__ */ Qt(Sk), { getOwnPropertyNames: _k, getOwnPropertySymbols: Ok } = Object, { hasOwnProperty: Ak } = Object.prototype;
function Zm(t, e) {
...
function g2(t) {
  return _k(t).concat(Ok(t));
}
const Tk = (
  // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
  Object.hasOwn || ((t, e) => Ak.call(t, e))
);
function ci(t, e) {
  return t === e || !t && !e && t !== t && e !== e;
}
const Ek = "__v", Mk = "__o", jk = "_owner", { getOwnPropertyDescriptor: b2, keys: x2 } = Object;
function Ck(t, e) {
...
function hD(t, e, n, r) {
  return (r === jk || r === Mk || r === Ek) && (t.$$typeof || e.$$typeof) ? !0 : Tk(e, r) && n.equals(t[r], e[r], r, r, t, e, n);
}
const Uk = "[object ArrayBuffer]", Hk = "[object Arguments]", Ik = "[object Boolean]", Gk = "[object DataView]", Yk = "[object Date]", Xk = "[object Error]", Kk = "[object Map]", Vk = "[object Number]", Fk = "[object Object]", Zk = "[object RegExp]", Qk = "[object Set]", Wk = "[object String]", Jk = {
  "[object Int8Array]": !0,
  "[object Uint8Array]": !0,
...
}, tU = "[object URL]", eU = Object.prototype.toString;
function nU({ areArrayBuffersEqual: t, areArraysEqual: e, areDataViewsEqual: n, areDatesEqual: r, areErrorsEqual: u, areFunctionsEqual: l, areMapsEqual: c, areNumbersEqual: s, areObjectsEqual: h, arePrimitiveWrappersEqual: d, areRegExpsEqual: y, areSetsEqual: p, areTypedArraysEqual: g, areUrlsEqual: x, unknownTagComparators: O }) {
...
function rU({ circular: t, createCustomConfig: e, strict: n }) {
  let r = {
    areArrayBuffersEqual: Ck,
    areArraysEqual: n ? Go : Dk,
    areDataViewsEqual: Pk,
    areDatesEqual: Nk,
    areErrorsEqual: Rk,
    areFunctionsEqual: qk,
    areMapsEqual: n ? Zm(S2, Go) : S2,
    areNumbersEqual: zk,
    areObjectsEqual: n ? Go : $k,
    arePrimitiveWrappersEqual: Bk,
    areRegExpsEqual: Lk,
...
function iU({ circular: t, comparator: e, createState: n, equals: r, strict: u }) {
  if (n)
    return function(s, h) {
...
function Oa(t = {}) {
  const { circular: e = !1, createInternalComparator: n, createState: r, strict: u = !1 } = t, l = rU(t), c = nU(l), s = n ? n(c) : aU(c);
  return iU({ circular: e, comparator: c, createState: r, equals: s, strict: u });
}
function oU(t) {
  ...
  var t = {}, e = function() {
    ...
    if (!n) {
      if (Array.isArray(l)) {
        if (!l.length)
          return;
        var c = l, s = lU(c), h = s[0], d = s.slice(1);
        if (typeof h == "number") {
          O2(u.bind(null, d), h);
          return;
        }
...
var yU = function(e, n) {
  ...
  return e.map(function(u) {
    return "".concat(gU(u), " ").concat(n, "ms ").concat(r);
  }).join(",");
};
function bU(t, e) {
  return _U(t) || SU(t, e) || vD(t, e) || xU();
}
function xU() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var is = 1e-4, pD = function(e, n) {
  ...
  return function(r) {
    var u = pD(e, n), l = [].concat(OU(u.map(function(c, s) {
      return c * s;
    }).slice(1)), [0]);
    return yD(l, r);
  };
  ...
  var p = M2(u, c), g = M2(l, s), x = EU(u, c), O = function(A) {
...
function pb(t, e, n) {
  return e = NU(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function NU(t) {
  var e = RU(t, "string");
...
var us = function(e, n, r) {
  ...
  var u = tl(function(l, c) {
    if (mb(c)) {
      var s = e(c.from, c.to, c.velocity), h = qU(s, 2), d = h[0], y = h[1];
      return Ne(Ne({}, c), {}, {
        from: d,
        velocity: y
      });
...
const kU = (function(t, e, n, r, u) {
  var l = yU(t, e), c = l.reduce(function(b, A) {
    ...
    d || (d = A);
    var T = A - d, M = T / n.dt;
    s = LU(n, s, M), u(Ne(Ne(Ne({}, t), e), g())), d = A, x() || (h = requestAnimationFrame(p));
  }, S = function(A) {
    y || (y = A);
...
var UU = ["children", "begin", "duration", "attributeName", "easing", "isActive", "steps", "from", "to", "canBegin", "onAnimationEnd", "shouldReAnimate", "onAnimationReStart"];
function HU(t, e) {
  if (t == null) return {};
  var n = IU(t, e), r, u;
  if (Object.getOwnPropertySymbols) {
...
function ZU(t, e, n) {
  return e && FU(t.prototype, e), Object.defineProperty(t, "prototype", { writable: !1 }), t;
}
function gD(t) {
  var e = QU(t, "string");
  ...
  return ZU(n, [{
    ...
    value: function(u) {
      ...
      if (s) {
        ...
        if (!(uU(u.to, y) && u.canBegin && u.isActive)) {
    ...
    key: "runJSAnimation",
    value: function(u) {
      var l = this, c = u.from, s = u.to, h = u.duration, d = u.easing, y = u.begin, p = u.onAnimationEnd, g = u.onAnimationStart, x = kU(c, s, jU(d), h, this.changeStyle), O = function() {
        l.stopJSAnimation = x();
      };
    ...
    value: function(u) {
      var l = this, c = u.steps, s = u.begin, h = u.onAnimationStart, d = c[0], y = d.style, p = d.duration, g = p === void 0 ? 0 : p, x = function(S, b, A) {
        ...
        return [].concat(Qm(S), [k, T, D]).filter(mU);
      };
    ...
    value: function() {
      ...
      var h = HU(u, UU), d = rt.Children.count(l), y = this.state.style;
      if (typeof l == "function")
        return l(y);
      if (!s || d === 0 || c <= 0)
        return l;
      var p = function(x) {
        var O = x.props, S = O.style, b = S === void 0 ? {} : S, A = O.className, T = /* @__PURE__ */ rt.cloneElement(x, Bn(Bn({}, h), {}, {
          style: Bn(Bn({}, b), y),
          className: A
        }));
        return T;
...
function nH() {
  ...
  return t(), Wm.exports = eH(), Wm.exports;
}
function Tl(t) {
  "@babel/helpers - typeof";
...
var B2 = function(e, n, r, u, l) {
  ...
  var n = $2($2({}, hH), e), r = rt.useRef(), u = rt.useState(-1), l = rH(u, 2), c = l[0], s = l[1];
  rt.useEffect(function() {
...
var Ks = function(e) {
  ...
  return n === +n && r === +r && u === +u ? /* @__PURE__ */ rt.createElement("circle", _b({}, Et(e, !1), Ef(e), {
    className: c,
    cx: n,
    cy: r,
    r: u
...
var dH = ["x", "y", "top", "left", "width", "height", "className"];
function Ob() {
...
function pH(t, e, n) {
  return e = yH(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function yH(t) {
  var e = mH(t, "string");
...
var xH = function(e, n, r, u, l, c) {
  return "M".concat(e, ",").concat(l, "v").concat(u, "M").concat(c, ",").concat(n, "h").concat(r);
}, SH = function(e) {
  var n = e.x, r = n === void 0 ? 0 : n, u = e.y, l = u === void 0 ? 0 : u, c = e.top, s = c === void 0 ? 0 : c, h = e.left, d = h === void 0 ? 0 : h, y = e.width, p = y === void 0 ? 0 : y, g = e.height, x = g === void 0 ? 0 : g, O = e.className, S = gH(e, dH), b = vH({
    x: r,
    y: l,
    top: s,
    left: d,
...
function OH() {
  if (U2) return tg;
  U2 = 1;
  var t = $r(), e = _H(), n = Br(), r = "[object Object]", u = Function.prototype, l = Object.prototype, c = u.toString, s = l.hasOwnProperty, h = c.call(Object);
  function d(y) {
    if (!n(y) || t(y) != r)
      return !1;
    var p = e(y);
...
function RH(t, e, n) {
  return e = qH(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function qH(t) {
  var e = zH(t, "string");
  return Ml(e) == "symbol" ? e : e + "";
...
var X2 = function(e, n, r, u, l) {
  ...
  var n = Y2(Y2({}, $H), e), r = rt.useRef(), u = rt.useState(-1), l = jH(u, 2), c = l[0], s = l[1];
  rt.useEffect(function() {
    if (r.current && r.current.getTotalLength)
      try {
...
}, LH = ["option", "shapeType", "propTransformer", "activeClassName", "isActive"];
function jl(t) {
  "@babel/helpers - typeof";
...
function HH(t, e, n) {
  return e = IH(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function IH(t) {
  var e = GH(t, "string");
...
function V2(t) {
  ...
  switch (e) {
    ...
    case "trapezoid":
      return /* @__PURE__ */ B.createElement(BH, n);
    case "sector":
...
function VH(t) {
  var e = t.option, n = t.shapeType, r = t.propTransformer, u = r === void 0 ? YH : r, l = t.activeClassName, c = l === void 0 ? "recharts-active-shape" : l, s = t.isActive, h = kH(t, LH), d;
  if (/* @__PURE__ */ rt.isValidElement(e))
    d = /* @__PURE__ */ rt.cloneElement(e, fs(fs({}, h), KH(e)));
  else if (At(e))
    d = e(h);
  else if (wH(e) && !MH(e)) {
    var y = u(e, h);
...
function WH(t, e) {
  var n;
  return Vs(t, e) ? n = FH : Fs(t, e) ? n = ZH : Cl(t, e) && (n = QH), n;
}
function JH(t, e) {
  var n;
...
function e9(t) {
  var e = t.activeTooltipItem, n = t.graphicalItem, r = t.itemData, u = JH(n, e), l = t9(n, e), c = r.filter(function(h, d) {
...
function xD(t, e, n) {
  return e = u9(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function u9(t) {
  var e = o9(t, "string");
...
var l9 = ["Webkit", "Moz", "O", "ms"], c9 = function(e, n) {
  var r = e.replace(/(\w)/, function(l) {
    return l.toUpperCase();
  }), u = l9.reduce(function(l, c) {
...
function h9(t, e, n) {
  return e = ds(e), d9(t, SD() ? Reflect.construct(e, n || [], ds(t).constructor) : e.apply(t, n));
}
function d9(t, e) {
...
var m9 = function(e) {
  ...
  function e(n) {
    var r;
    return f9(this, e), r = h9(this, e, [n]), sn(r, "handleDrag", function(u) {
  ...
  return p9(e, t), s9(e, [{
    ...
    value: function() {
      ...
      if (!u || !u.length || !st(s) || !st(h) || !st(d) || !st(y) || d <= 0 || y <= 0)
        return null;
      var M = qt("recharts-brush", l), C = B.Children.count(c) === 1, w = c9("userSelect", "none");
      return /* @__PURE__ */ B.createElement(Jt, {
        className: M,
...
function D9(t, e, n) {
  return e = P9(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function P9(t) {
  var e = N9(t, "string");
...
function z9(t, e) {
  var n = t.x, r = t.y, u = R9(t, C9), l = "".concat(n), c = parseInt(l, 10), s = "".concat(r), h = parseInt(s, 10), d = "".concat(e.height || u.height), y = parseInt(d, 10), p = "".concat(e.width || u.width), g = parseInt(p, 10);
...
function hM(t) {
  return /* @__PURE__ */ B.createElement(VH, wb({
    shapeType: "rectangle",
    propTransformer: z9,
...
function I9(t, e, n) {
  return e = ps(e), G9(t, wD() ? Reflect.construct(e, n || [], ps(t).constructor) : e.apply(t, n));
}
function G9(t, e) {
...
var fi = /* @__PURE__ */ (function(t) {
  function e() {
    ...
    for (var r = arguments.length, u = new Array(r), l = 0; l < r; l++)
      u[l] = arguments[l];
    return n = I9(this, e, [].concat(u)), ma(n, "state", {
...
ma(fi, "getComposedData", function(t) {
  var e = t.props, n = t.item, r = t.barPosition, u = t.bandSize, l = t.xAxis, c = t.yAxis, s = t.xAxisTicks, h = t.yAxisTicks, d = t.stackedData, y = t.dataStartIndex, p = t.displayedData, g = t.offset, x = u5(r, n);
  if (!x)
    return null;
  var O = e.layout, S = n.type.defaultProps, b = S !== void 0 ? me(me({}, S), n.props) : n.props, A = b.dataKey, T = b.children, M = b.minPointSize, C = O === "horizontal" ? c : l, w = d ? C.scale.domain() : null, E = v5({
    numericAxis: C
  }), D = Cn(T, g0), R = p.map(function(z, F) {
    var k, $, K, Z, V, N;
    d ? k = o5(d[y + F], w) : (k = Ge(z, A), Array.isArray(k) || (k = [E, k]));
    var I = $9(M, AD.defaultProps.minPointSize)(k[1], F);
    if (O === "horizontal") {
...
var Y0 = function(e, n, r, u, l) {
  ...
  return y.reduce(function(x, O) {
    ...
    if (S.type === "number" && (S.padding === "gap" || S.padding === "no-gap")) {
      var $ = A[1] - A[0], K = 1 / 0, Z = S.categoricalDomain.sort(Y3);
    ...
    var ut = a5(S, l, g), lt = ut.scale, P = ut.realScaleType;
    lt.domain(A).range(R), i5(lt);
    var U = d5(lt, Ln(Ln({}, S), {}, {
      realScaleType: P
    }));
...
var J9 = function(e) {
  var n = e.width, r = e.height, u = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, l = W9(u), c = l * Math.PI / 180, s = Math.atan(r / n), h = c > s && c < Math.PI - s ? r / Math.sin(c) : n / Math.cos(c);
  return Math.abs(h);
}, vg, mM;
function t7() {
  if (mM) return vg;
...
var a7 = r7();
const i7 = /* @__PURE__ */ Qt(a7);
var u7 = ij();
const o7 = /* @__PURE__ */ Qt(u7);
var l7 = o7(function(t) {
  return {
    x: t.left,
    y: t.top,
    width: t.width,
...
}), K0 = /* @__PURE__ */ rt.createContext(void 0), V0 = /* @__PURE__ */ rt.createContext(void 0), CD = /* @__PURE__ */ rt.createContext(void 0), DD = /* @__PURE__ */ rt.createContext({}), PD = /* @__PURE__ */ rt.createContext(void 0), ND = /* @__PURE__ */ rt.createContext(0), RD = /* @__PURE__ */ rt.createContext(0), SM = function(e) {
  var n = e.state, r = n.xAxisMap, u = n.yAxisMap, l = n.offset, c = e.clipPathId, s = e.children, h = e.width, d = e.height, y = l7(l);
  ...
  return rt.useContext(PD);
}, qD = function(e) {
  var n = rt.useContext(K0);
  n == null && ri();
  var r = n[e];
  return r == null && ri(), r;
}, f7 = function() {
  var e = rt.useContext(K0);
  return pa(e);
}, s7 = function() {
  var e = rt.useContext(V0), n = i7(e, function(r) {
    return OD(r.domain, Number.isFinite);
  });
  return n || pa(e);
}, zD = function(e) {
  var n = rt.useContext(V0);
  n == null && ri();
  var r = n[e];
  return r == null && ri(), r;
}, h7 = function() {
  var e = rt.useContext(CD);
  return e;
}, d7 = function() {
  return rt.useContext(DD);
}, F0 = function() {
...
function y7(t, e, n) {
  return e && p7(t.prototype, e), Object.defineProperty(t, "prototype", { writable: !1 }), t;
}
function m7(t, e, n) {
  return e = ys(e), g7(t, $D() ? Reflect.construct(e, n || [], ys(t).constructor) : e.apply(t, n));
}
function g7(t, e) {
...
var E7 = function(e, n) {
  ...
  if (u) {
    ...
    return Jn(d, "discard") && S9(w, function(E) {
...
function j7(t) {
  var e = t.x, n = t.y, r = t.segment, u = t.xAxisId, l = t.yAxisId, c = t.shape, s = t.className, h = t.alwaysShow, d = c7(), y = qD(u), p = zD(l), g = h7();
  if (!d || !g)
    return null;
  ...
  var x = X0({
    x: y.scale,
    y: p.scale
  }), O = _e(e), S = _e(n), b = r && r.length === 2, A = M7(x, O, S, b, g, t.position, y.orientation, p.orientation, t);
  if (!A)
    return null;
  var T = _7(A, 2), M = T[0], C = M.x, w = M.y, E = T[1], D = E.x, R = E.y, z = Jn(t, "hidden") ? "url(#".concat(d, ")") : void 0, F = OM(OM({
    clipPath: z
  }, Et(t, !0)), {}, {
    x1: C,
    y1: w,
  ...
  }, E7(c, F), ke.renderCallByParent(t, Q9({
    x1: C,
    y1: w,
    x2: D,
    y2: R
...
var W0 = /* @__PURE__ */ (function(t) {
  function e() {
    return v7(this, e), m7(this, e, arguments);
  }
  return x7(e, t), y7(e, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ B.createElement(j7, this.props);
    }
  }]);
})(B.Component);
...
function P7(t, e, n) {
  return e && D7(t.prototype, e), Object.defineProperty(t, "prototype", { writable: !1 }), t;
}
function N7(t, e, n) {
  return e = ms(e), R7(t, LD() ? Reflect.construct(e, n || [], ms(t).constructor) : e.apply(t, n));
}
function R7(t, e) {
...
var B7 = function(e) {
  ...
  function e() {
    return C7(this, e), N7(this, e, arguments);
  }
  return z7(e, t), P7(e, [{
    key: "render",
    value: function() {
...
function H7(t, e, n) {
  return e = gs(e), I7(t, UD() ? Reflect.construct(e, n || [], gs(t).constructor) : e.apply(t, n));
}
function I7(t, e) {
...
var K7 = function(e, n, r, u, l) {
  ...
  function e() {
    return L7(this, e), H7(this, e, arguments);
  }
  return Y7(e, t), U7(e, [{
    key: "render",
    value: function() {
...
function J0(t, e, n) {
  ...
  if (!u || !u.length || !r)
    return [];
  if (st(h) || ui.isSsr)
    return Z7(u, typeof h == "number" && st(h) ? h : 0);
  ...
  }, b = u.length >= 2 ? Hn(u[1].coordinate - u[0].coordinate) : 1, A = F7(l, b, x);
  return h === "equidistantPreserveStart" ? Q7(b, A, S, u, c) : (h === "preserveStart" || h === "preserveStartEnd" ? g = nI(b, A, S, u, c, h === "preserveStartEnd") : g = eI(b, A, S, u, c), g.filter(function(T) {
    return T.isShow;
  }));
}
var rI = ["viewBox"], aI = ["viewBox"], iI = ["ticks"];
function Tu(t) {
  "@babel/helpers - typeof";
...
function cI(t, e, n) {
  return e = xs(e), fI(t, GD() ? Reflect.construct(e, n || [], xs(t).constructor) : e.apply(t, n));
}
function fI(t, e) {
...
var Uu = /* @__PURE__ */ (function(t) {
  function e(n) {
    var r;
    return oI(this, e), r = cI(this, e, [n]), r.state = {
      fontSize: "",
      letterSpacing: ""
    }, r;
  }
  return hI(e, t), lI(e, [{
    ...
    value: function(r, u) {
      var l = r.viewBox, c = gg(r, rI), s = this.props, h = s.viewBox, d = gg(s, aI);
    ...
    value: function() {
      ...
      if (y)
        return null;
      var p = this.props, g = p.ticks, x = gg(p, iI), O = g;
...
var vI = ["x1", "y1", "x2", "y2", "key"], pI = ["offset"];
function ai(t) {
  "@babel/helpers - typeof";
...
function XD(t, e) {
  ...
  if (/* @__PURE__ */ B.isValidElement(t))
    ...
    var r = e.x1, u = e.y1, l = e.x2, c = e.y2, s = e.key, h = NM(e, vI), d = Et(h, !1);
    d.offset;
    var y = NM(d, pI);
...
function Zo(t) {
  var e, n, r, u, l, c, s = F0(), h = Z0(), d = d7(), y = Ue(Ue({}, t), {}, {
  ...
  }), p = y.x, g = y.y, x = y.width, O = y.height, S = y.syncWithTicks, b = y.horizontalValues, A = y.verticalValues, T = f7(), M = s7();
  if (!st(x) || x <= 0 || !st(O) || O <= 0 || !st(p) || p !== +p || !st(g) || g !== +g)
    return null;
  var C = y.verticalCoordinatesGenerator || wI, w = y.horizontalCoordinatesGenerator || TI, E = y.horizontalPoints, D = y.verticalPoints;
  if ((!E || !E.length) && At(w)) {
  ...
  return /* @__PURE__ */ B.createElement("g", {
    ...
    horizontalPoints: E
  })), /* @__PURE__ */ B.createElement(AI, Fa({}, y, {
    verticalPoints: D
  })));
}
Zo.displayName = "CartesianGrid";
var EI = ["type", "layout", "connectNulls", "ref"], MI = ["key"];
function Eu(t) {
  "@babel/helpers - typeof";
...
function zI(t, e, n) {
  return e = Ss(e), $I(t, KD() ? Reflect.construct(e, n || [], Ss(t).constructor) : e.apply(t, n));
}
function $I(t, e) {
...
var Ja = /* @__PURE__ */ (function(t) {
  function e() {
    ...
    for (var r = arguments.length, u = new Array(r), l = 0; l < r; l++)
      u[l] = arguments[l];
    return n = zI(this, e, [].concat(u)), kn(n, "state", {
      isAnimationFinished: !0,
      totalLength: 0
  ...
  return LI(e, t), qI(e, [{
    ...
    value: function(r, u, l, c) {
      ...
      s.ref;
      var p = RM(s, EI), g = fn(fn(fn({}, Et(p, !0)), {}, {
        fill: "none",
    ...
    value: function(r, u) {
      ...
      if (/* @__PURE__ */ B.isValidElement(r))
        ...
        var c = u.key, s = RM(u, MI), h = qt("recharts-line-dot", typeof r != "boolean" ? r.className : "");
...
var UI = ["layout", "type", "stroke", "connectNulls", "isRange", "ref"], HI = ["key"], FD;
function Mu(t) {
  "@babel/helpers - typeof";
...
function XI(t, e, n) {
  return e = _s(e), KI(t, QD() ? Reflect.construct(e, n || [], _s(t).constructor) : e.apply(t, n));
}
function KI(t, e) {
...
var tr = /* @__PURE__ */ (function(t) {
  function e() {
    ...
    for (var r = arguments.length, u = new Array(r), l = 0; l < r; l++)
      u[l] = arguments[l];
    return n = XI(this, e, [].concat(u)), Qn(n, "state", {
      isAnimationFinished: !0
...
Qn(tr, "renderDotItem", function(t, e) {
  ...
  if (/* @__PURE__ */ B.isValidElement(t))
    ...
    var r = qt("recharts-area-dot", typeof t != "boolean" ? t.className : ""), u = e.key, l = ZD(e, HI);
...
function JI(t, e, n) {
  return e && WI(t.prototype, e), Object.defineProperty(t, "prototype", { writable: !1 }), t;
}
function tG(t, e, n) {
  return e = Os(e), eG(t, JD() ? Reflect.construct(e, n || [], Os(t).constructor) : e.apply(t, n));
}
function eG(t, e) {
...
function iG(t) {
  ...
  return u == null ? null : (
    ...
    /* @__PURE__ */ rt.createElement(Uu, Bb({}, u, {
...
var Mr = /* @__PURE__ */ (function(t) {
  function e() {
    return QI(this, e), tG(this, e, arguments);
  }
  return rG(e, t), JI(e, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ rt.createElement(iG, this.props);
    }
  }]);
})(rt.Component);
...
function cG(t, e, n) {
  return e = As(e), fG(t, nP() ? Reflect.construct(e, n || [], As(t).constructor) : e.apply(t, n));
}
function fG(t, e) {
...
var vG = function(e) {
  ...
  return l == null ? null : (
    // @ts-expect-error the axisOptions type is not exactly what CartesianAxis is expecting.
    /* @__PURE__ */ rt.createElement(Uu, kb({}, l, {
  ...
  function e() {
    return uG(this, e), cG(this, e, arguments);
  }
  return hG(e, t), lG(e, [{
    key: "render",
    value: function() {
      return /* @__PURE__ */ rt.createElement(vG, this.props);
    }
  }]);
})(rt.Component);
...
var xG = bG();
const SG = /* @__PURE__ */ Qt(xG);
var xg = new SG(), Sg = "recharts.syncMouseEvents";
function ql(t) {
  "@babel/helpers - typeof";
...
var TG = /* @__PURE__ */ (function() {
  function t() {
    _G(this, t), _g(this, "activeIndex", 0), _g(this, "coordinateList", []), _g(this, "layout", "horizontal");
  }
  return AG(t, [{
    key: "setDetails",
    value: function(n) {
...
function CG(t, e, n) {
  return e = DG(e), e in t ? Object.defineProperty(t, e, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : t[e] = n, t;
}
function DG(t) {
  var e = PG(t, "string");
...
function NG(t) {
  ...
  return /* @__PURE__ */ rt.isValidElement(x) ? /* @__PURE__ */ rt.cloneElement(x, E) : /* @__PURE__ */ rt.createElement(S, E);
}
var RG = ["item"], qG = ["children", "className", "width", "height", "style", "compact", "title", "desc"];
function Du(t) {
  "@babel/helpers - typeof";
  return Du = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(e) {
    return typeof e;
...
function IG(t, e, n) {
  return e = ws(e), GG(t, oP() ? Reflect.construct(e, n || [], ws(t).constructor) : e.apply(t, n));
}
function GG(t, e) {
  if (e && (Du(e) === "object" || typeof e == "function"))
    return e;
...
var Yb = function(e, n, r, u) {
  ...
  var l = u || {
    x: e.chartX,
    y: e.chartY
  }, c = JG(l, r), s = e.orderedTooltipTicks, h = e.tooltipAxis, d = e.tooltipTicks, y = WL(c, s, d, h);
  if (y >= 0 && d) {
    var p = d[y] && d[y].value, g = Yb(e, n, y, p), x = tY(r, s, y, l);
    return {
  ...
  return r.reduce(function(O, S) {
    ...
    EG(A.domain, C, T) && ($ = lb(A.domain, null, C), x && (T === "number" || E !== "auto") && (Z = Jo(F, M, "category")));
    var V = sP(T);
    if (!$ || $.length === 0) {
      ...
      if (M) {
        if ($ = Jo(F, M, T), T === "category" && x) {
          ...
          var ut = r5(F, u.filter(function(U) {
  ...
  return r.reduce(function(b, A) {
    ...
    if (!b[M]) {
      ...
      return O ? w = ss(0, x) : s && s[M] && s[M].hasStack ? (w = oD(s[M].stackGroups, h, d), w = Hb(p, w, M, l)) : (w = lb(C, aD(g, r.filter(function(E) {
        ...
        hide: !0,
        orientation: jn(QG, "".concat(l, ".").concat(S % 2), null),
        domain: w,
        originalDomain: C,
        isCategorical: O,
        layout: y
  ...
  x && (A.bottom += x.props.height || Su.defaultProps.height), O && n && (A = e5(A, u, r, n));
  ...
  var n = e.chartName, r = e.GraphicalChild, u = e.defaultTooltipEventType, l = u === void 0 ? "axis" : u, c = e.validateTooltipEventTypes, s = c === void 0 ? ["axis"] : c, h = e.axisComponents, d = e.legendContent, y = e.formatAxisMap, p = e.defaultProps, g = function(A, T) {
    var M = T.graphicalItems, C = T.stackGroups, w = T.offset, E = T.updateId, D = T.dataStartIndex, R = T.dataEndIndex, z = A.barSize, F = A.layout, k = A.barGap, $ = A.barCategoryGap, K = A.maxBarSize, Z = KM(F), V = Z.numericAxisName, N = Z.cateAxisName, I = iY(M), W = [];
    return M.forEach(function(ut, lt) {
      ...
      }, jt), ct = kt[N], xt = kt["".concat(N, "Ticks")], St = C && C[vt] && C[vt].hasStack && p5(ut, C[vt].stackGroups), ot = Cr(ut.type).indexOf("Bar") >= 0, te = es(ct, xt), wt = [], ue = I && JL({
        barSize: z,
        stackGroups: C,
        totalSize: oY(kt, N)
      });
    ...
    if (!yA({
      ...
      return null;
    var D = M.children, R = M.layout, z = M.stackOffset, F = M.data, k = M.reverseStackOrder, $ = KM(R), K = $.numericAxisName, Z = $.cateAxisName, V = Cn(D, r), N = h5(F, V, "".concat(K, "Id"), "".concat(Z, "Id"), z, k), I = h.reduce(function(U, et) {
      var ft = "".concat(et.axisType, "Map");
      return tt(tt({}, U), {}, bt({}, ft, rY(M, tt(tt({}, et), {}, {
        graphicalItems: V,
    ...
    var ut = I["".concat(Z, "Map")], lt = aY(ut), P = g(M, tt(tt({}, I), {}, {
      dataStartIndex: C,
      dataEndIndex: w,
      updateId: E,
      graphicalItems: V,
    ...
    function A(T) {
      var M, C, w;
      return kG(this, A), w = IG(this, A, [T]), bt(w, "eventEmitterSymbol", Symbol("rechartsEventEmitter")), bt(w, "accessibilityManager", new TG()), bt(w, "handleLegendBBoxUpdate", function(E) {
        if (E) {
        ...
        var D = eq(E), R = jn(w.props, "".concat(D));
        if (D && At(R)) {
          var z, F;
        ...
        return /* @__PURE__ */ B.createElement(NG, {
          key: W,
          activeCoordinate: F,
          activePayload: k,
    ...
    return XG(A, b), HG(A, [{
      ...
      value: function(M) {
        if (!this.container)
          return null;
        var C = this.container, w = C.getBoundingClientRect(), E = HB(w), D = {
      ...
      value: function() {
        ...
        if (!yA(this))
          return null;
        var C = this.props, w = C.children, E = C.className, D = C.width, R = C.height, z = C.style, F = C.compact, k = C.title, $ = C.desc, K = IM(C, qG), Z = Et(K, !1);
        if (F)
  ...
  bt(O, "displayName", n), bt(O, "defaultProps", tt({
    ...
    var M;
    return /* @__PURE__ */ rt.isValidElement(b) ? M = /* @__PURE__ */ rt.cloneElement(b, A) : At(b) ? M = b(A) : M = /* @__PURE__ */ B.createElement(Ks, A), /* @__PURE__ */ B.createElement(Jt, {
      className: "recharts-active-dot",
      key: T
    }, M);
  });
  var S = /* @__PURE__ */ rt.forwardRef(function(A, T) {
...
function fY({
  ...
  if (n === "flow") {
    const S = t3(t, e, r), b = (A) => u ? A.toFixed(2) : LR(A);
    return /* @__PURE__ */ it.jsx(df, { width: "100%", height: 340, children: /* @__PURE__ */ it.jsxs(cY, { data: S, children: [
  ...
  if (n === "category") {
    ...
    return /* @__PURE__ */ it.jsx(df, { width: "100%", height: 340, children: /* @__PURE__ */ it.jsxs(lY, { data: A, children: [
      /* @__PURE__ */ it.jsx(Zo, { stroke: "#223047", strokeDasharray: "3 3" }),
      /* @__PURE__ */ it.jsx(Mr, { dataKey: "ts", tickFormatter: c, tick: ha, minTickGap: 40 }),
      /* @__PURE__ */ it.jsx(jr, { tickFormatter: h, tick: ha, width: 90, domain: ["auto", "auto"] }),
      /* @__PURE__ */ it.jsx(
...
function hP({
  ...
  const n = lu.find((b) => b.key === (e.view ?? "all")) ?? lu[2], [r, u] = rt.useState(e.range ?? "6m"), [l, c] = rt.useState(
    e.mode && n.modes.includes(e.mode) ? e.mode : n.defaultMode
  ), { overview: s, series: h, masked: d, error: y, refresh: p } = Kb(t, e.entry, r), g = Fb(s), x = rt.useMemo(() => g.filter(n.pick), [g, n]), O = rt.useMemo(() => {
    if (!h) return [];
  ...
  return /* @__PURE__ */ it.jsxs("div", { className: "card", children: [
    ...
    !y && s && h && O.length > 0 && /* @__PURE__ */ it.jsx(fY, { rows: O, accounts: x, mode: l, range: r, masked: d })
  ] });
}
...
var ZM;
function hY() {
  return ZM || (ZM = 1, Ag.exports = sY()), Ag.exports;
}
/**
 * @license React
...
` + f.stack;
        ...
        if (at !== Y.lane ? (Pt & at) === at : (hr & at) === at) {
          ...
          if (X === 0)
            ...
            at = {
              ...
              eagerState: Y.eagerState,
              next: null
            }, q === null ? (j = q = at, _ = m) : q = q.next = at, Ot.lanes |= X, ea |= X;
          ...
          X = {
            ...
            eagerState: Y.eagerState,
            next: null
          }, q === null ? (j = q = X, _ = m) : q = q.next = X, Ot.lanes |= at, ea |= at;
        Y = Y.next;
      } while (Y !== null && Y !== i);
  ...
  function OS(a, i, o, f, v) {
    if (Na(i), i.stateNode === null) {
      ...
      J = typeof at == "function" || typeof m.getSnapshotBeforeUpdate == "function", j = i.pendingProps !== j, J || typeof m.UNSAFE_componentWillReceiveProps != "function" && typeof m.componentWillReceiveProps != "function" || (j || Y !== _) && cS(
        i,
        m,
        f,
        _
      ...
      m.state = X, so(i, f, m, v), fo(), Y = i.memoizedState, j || X !== Y || Vr ? (typeof at == "function" && (bd(
        i,
        o,
        at,
        f
      ...
      m = i.stateNode, Zh(a, i), _ = i.memoizedProps, J = La(o, _), m.props = J, at = i.pendingProps, X = m.context, Y = o.contextType, q = Ai, typeof Y == "object" && Y !== null && (q = Ce(Y)), j = o.getDerivedStateFromProps, (Y = typeof j == "function" || typeof m.getSnapshotBeforeUpdate == "function") || typeof m.UNSAFE_componentWillReceiveProps != "function" && typeof m.componentWillReceiveProps != "function" || (_ !== at || X !== q) && cS(
        i,
        m,
        f,
        q
      ...
      _ !== at || X !== Q || Vr || a !== null && a.dependencies !== null && hc(a.dependencies) ? (typeof j == "function" && (bd(
        i,
        o,
        j,
        f
      ...
      if ("selectionStart" in a)
        ...
        t: {
          ...
          if (f && f.rangeCount !== 0) {
            ...
            var _ = 0, j = -1, q = -1, Y = 0, J = 0, at = a, X = null;
            e: for (; ; ) {
              for (var Q; at !== o || v !== 0 && at.nodeType !== 3 || (j = _ + v), at !== m || f !== 0 && at.nodeType !== 3 || (q = _ + f), at.nodeType === 3 && (_ += at.nodeValue.length), (Q = at.firstChild) !== null; )
                X = at, at = Q;
              for (; ; ) {
                if (at === a) break e;
                if (X === o && ++Y === v && (j = _), X === m && ++J === f && (q = _), (Q = at.nextSibling) !== null) break;
  ...
  function JS(a, i, o, f, v, m, _, j, q, Y, J, at, X, Q) {
          ...
          if (_ !== j && j && j.ownerDocument && K1(
            ...
            if (q !== null && Mh(j)) {
              ...
              if (J === void 0 && (J = Y), "selectionStart" in j)
                ...
                var at = j.ownerDocument || document, X = at && at.defaultView || window;
                if (X.getSelection) {
            ...
            for (at = [], Q = j; Q = Q.parentNode; )
              Q.nodeType === 1 && at.push({
                element: Q,
                left: Q.scrollLeft,
                top: Q.scrollTop
              });
            for (typeof j.focus == "function" && j.focus(), j = 0; j < at.length; j++) {
              var nt = at[j];
    ...
    E1(function() {
      ...
      if ((i & 7) === 0) {
        ...
        Nt && (N1 && o.locale !== "ko" && (xi || Nt !== "onCompositionStart" ? Nt === "onCompositionEnd" && xi && (Tt = M1()) : (Ir = J, xh = "value" in Ir ? Ir.value : Ir.textContent, xi = !0)), pt = Kc(Y, Nt), 0 < pt.length && (Nt = new D1(
          ...
          o,
          J
        ), at.push({ event: Nt, listeners: pt }), Tt ? Nt.data = Tt : (Tt = $1(o), Tt !== null && (Nt.data = Tt)))), (Tt = eN ? nN(a, o) : rN(a, o)) && (Nt = Kc(Y, "onBeforeInput"), 0 < Nt.length && (pt = new D1(
          "onBeforeInput",
          "beforeinput",
          null,
          o,
...
`).replace(tR, "");
      ...
      for (var a = 0, i = 0, o = performance.getEntriesByType("resource"), f = 0; f < o.length; f++) {
        ...
        if (m && j && T_(_)) {
          for (_ = 0, j = v.responseEnd, f += 1; f < o.length; f++) {
            ...
            J && T_(at) && (q = q.responseEnd, _ += J * (q < j ? 1 : (j - Y) / (q - Y)));
          }
  ...
  function Y_(a, i, o, f, v, m, _, j, q, Y, J, at) {
    return a = new AR(
      a,
      i,
      o,
...
function vY() {
  ...
  return t(), Og.exports = dY(), Og.exports;
}
var pY = vY();
const yY = `
  --nb-bg: #121a27;
...
function nh(t) {
  class e extends HTMLElement {
    ...
    _render() {
      ...
      this._style || (this._style = document.createElement("style"), c.appendChild(this._style)), this._style.textContent = gY(this._config.theme ?? "netboi"), this._mount || (this._mount = document.createElement("div"), c.appendChild(this._mount), this._root = pY.createRoot(this._mount));
      const s = t.component;
      this._root.render(
  ...
  class n extends HTMLElement {
    ...
    set hass(c) {
      this._hass = c, this._entries || IR(c).then((s) => {
